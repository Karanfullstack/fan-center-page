        ...
        <footer className="max-w-[1400px]  flex p-5 justify-center md:p-10 md:items-end items-center  container mx-auto w-full  min-h-[100dvh]  ">
            <section className="max-w-[1360px] p-4 md:p-8 gap-5 flex flex-col  bg-seconday min-h-[30rem] md:min-h-[30rem] w-full mx-auto">
                ...
                <div className="text-base h-[4rem]  md:h-auto flex justify-center flex-col items-start">
                    <p className="text-xl md:text-2xl font-medium leading-[1.5]">Napisz do nas:</p>
                    <p className="font-bold text-[clamp(1.5rem,1.2rem,1.5rem)] leading-[1.5] underline md:text-[1.9rem] ">
                        partners@foova.org
                    </p>
                </div>
                {/* footer section */}
                <div className="max-w-[20.0625rem]  md:max-w-full md:w-full w-full gap-2 flex flex-col justify-end items-center text-base h-[7.3rem]  border-b-0 border-x-0 border border-t-[#FFFFFF4D] ">
