        ...
        <article className="flex flex-col space-y-7  items-center font-hubot-semicondensed px-5 pt-10 md:pt-14 container min-h-[100dvh] mx-w-[1400px] w-full mx-auto justify-start">
            <figure className="h-full flex w-full lg:flex-row lg:space-x-6   lg:space-y-0   space-y-9 flex-col items-start justify-center">
                ...
                >
                    ...
                    <div
                        className="max-w-[min(800px,100%)] lg:flex-row lg:justify-between lg:items-center md:space-y-2 lg:space-y-0  space-y-1 p-4 flex flex-col justify-start items-start font-hubot-semicondensed w-full mx-auto bg-seconday min-h-[116px]  lg:min-h-[64px]  
